...
variable "drive2-id" {
  description = "The second drive's ID"

  type    = string
  default = ""
}

variable "drive2-idlocal" {
  description = "The second drive's device mapper local ID - name that can be used to access an attached disk under /dev/disk/by-id/"
